...
public class ControladorApoderado {
    ...
    private ListaEnlazadaApoderado listaEnlazadaApoderado = new ListaEnlazadaApoderado();
    private daoApoderado miDaoApoderado;
    ...
    public ControladorApoderado(moduloAlumnoApoderado a) {
        ...
        miDaoApoderado = new daoApoderado();
        dao = new daoApoderado();
    }
    ...
    if (filaSeleccionada >= 0) {
        ...
        if (confir == 0) {
            ...
            if (miDaoApoderado.borrarApoderado(dni, listaEnlazadaApoderado)) {
                limpiar();
            } else {
    ...
    public void registrar() {
        ...
        if (!espaciosVacios) {
            if (consultaDni.getValido()) {
                ...
                if (confir == 0) {
                    listaEnlazadaApoderado.añadirApoderado(apoderado);
                    limpiar();
                    dao.registrarApoderadosEnBaseDeDatos(listaEnlazadaApoderado);
                    consultarApo();
                }
            } else {
